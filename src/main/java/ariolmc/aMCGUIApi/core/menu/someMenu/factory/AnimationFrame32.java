...
public class AnimationFrame32 implements MenuFactory{

    @Override
    public Menu create(){
        Menu menu = new BaseMenuFactory(27, Component.text("Frame32")).create();
        ...
        services.setItemGUI(menu, itemGUI2, 0, 1, 2, 3, 9, 10, 11, 12, 18, 19, 20, 21);
        services.setItemGUI(menu, itemGUI1, 5, 6, 7, 8, 14, 15, 16, 17, 23, 24, 25, 26);
