...
public class AnimationFrame21 implements MenuFactory{

    @Override
    public Menu create(){
        Menu menu = new BaseMenuFactory(18, Component.text("Frame21")).create();
        ...
        services.setItemGUI(menu, itemGUI1, 0, 1, 2, 3, 9, 10, 11, 12);
        services.setItemGUI(menu, itemGUI2, 5, 6, 7, 8, 14, 15, 16, 17);
