...
public class TestMenuFactory2 implements MenuFactory{
    ...
    private final BaseMenuFactory menuFactory = new BaseMenuFactory(27, Component.text("test2"));
    ...
    public Menu create() {
        ...
        ItemGUI itemGUI = new DecorItemGUIFactory(new ItemStackBuilder(Material.BLUE_STAINED_GLASS_PANE).name(component).build()).create();
