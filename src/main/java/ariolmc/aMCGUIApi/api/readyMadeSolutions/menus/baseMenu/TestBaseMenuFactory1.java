...
public class TestBaseMenuFactory1 implements MenuFactory {
    ...
    public Menu create() {
        ...
        ItemGUI itemGUI = new DecorItemGUIFactory(new ItemStackBuilder(Material.BLACK_STAINED_GLASS_PANE)
